...
var require_polyfills = __commonJS({
  "../../node_modules/.pnpm/graceful-fs@4.2.10/node_modules/graceful-fs/polyfills.js"(
    ...
    process.cwd = function () {
      if (!cwd2) cwd2 = origCwd.call(process);
      return cwd2;
    };
    try {
      process.cwd();
...
var require_graceful_fs = __commonJS({
  "../../node_modules/.pnpm/graceful-fs@4.2.10/node_modules/graceful-fs/graceful-fs.js"(
    ...
    var debug4 = noop;
    if (util2.debuglog) debug4 = util2.debuglog("gfs4");
      ...
      function readdir(path5, options, cb) {
        ...
        var go$readdir = noReaddirOptionVersions.test(process.version)
          ? function go$readdir2(path6, options2, cb2, startTime) {
              return fs$readdir(
                path6,
                fs$readdirCallback(path6, options2, cb2, startTime)
              );
            }
          : function go$readdir2(path6, options2, cb2, startTime) {
              return fs$readdir(
  ...
  "../../node_modules/.pnpm/fs-extra@11.1.1/node_modules/fs-extra/lib/util/stat.js"(
    ...
    function getStats(src, dest, opts) {
      const statFunc = opts.dereference
        ? (file2) => fs3.stat(file2, { bigint: true })
        : (file2) => fs3.lstat(file2, { bigint: true });
      return Promise.all([
        statFunc(src),
    ...
    function getStatsSync(src, dest, opts) {
      let destStat;
      const statFunc = opts.dereference
        ? (file2) => fs3.statSync(file2, { bigint: true })
        : (file2) => fs3.lstatSync(file2, { bigint: true });
    ...
    function checkParentPaths(src, srcStat, dest, funcName, cb) {
      ...
      if (
        ...
        destParent === path5.parse(destParent).root
      )
        return cb();
...
var require_empty = __commonJS({
  "../../node_modules/.pnpm/fs-extra@11.1.1/node_modules/fs-extra/lib/empty/index.js"(
    ...
    var emptyDir = u(async function emptyDir2(dir) {
      ...
      return Promise.all(
        items.map((item) => remove.remove(path5.join(dir, item)))
      );
    });
    ...
    function createSymlink(srcpath, dstpath, type, callback) {
      ...
      fs3.lstat(dstpath, (err, stats) => {
        if (!err && stats.isSymbolicLink()) {
          Promise.all([fs3.stat(srcpath), fs3.stat(dstpath)]).then(
            ([srcStat, dstStat]) => {
...
var require_common_path_prefix = __commonJS({
  "../../node_modules/.pnpm/common-path-prefix@3.0.0/node_modules/common-path-prefix/index.js"(
    ...
    module2.exports = function commonPathPrefix2(
      paths2,
      sep = determineSeparator(paths2)
    ) {
...
var require_env_paths = __commonJS({
  "../../node_modules/.pnpm/env-paths@2.2.1/node_modules/env-paths/index.js"(
    ...
    var windows = (name) => {
      ...
      const localAppData =
        env2.LOCALAPPDATA || path5.join(homedir, "AppData", "Local");
      return {
    ...
    var linux = (name) => {
      ...
      return {
        data: path5.join(
          env2.XDG_DATA_HOME || path5.join(homedir, ".local", "share"),
          name
        ),
        config: path5.join(
          env2.XDG_CONFIG_HOME || path5.join(homedir, ".config"),
          name
        ),
        cache: path5.join(
          env2.XDG_CACHE_HOME || path5.join(homedir, ".cache"),
          name
        ),
        // https://wiki.debian.org/XDGBaseDirectorySpecification#state
        log: path5.join(
          env2.XDG_STATE_HOME || path5.join(homedir, ".local", "state"),
          name
        ),
...
var require_locate_path = __commonJS({
  "../../node_modules/.pnpm/locate-path@3.0.0/node_modules/locate-path/index.js"(
    ...
    module2.exports = (iterable, options) => {
      ...
      return pLocate2(
        iterable,
        (el) => pathExists2(path5.resolve(options.cwd, el)),
        options
      );
    };
...
var require_pkg_up = __commonJS({
  "../../node_modules/.pnpm/pkg-up@3.1.0/node_modules/pkg-up/index.js"(
    ...
    module2.exports = async ({ cwd: cwd2 } = {}) =>
      findUp2("package.json", { cwd: cwd2 });
    module2.exports.sync = ({ cwd: cwd2 } = {}) =>
      findUp2.sync("package.json", { cwd: cwd2 });
  },
});
  ...
  const debugCall = (...args) => {
    ...
    if (topProps.enabled(namespace3) || enabled) {
      ...
      if (globalThis.DEBUG_COLORS) {
        log(
          colors_exports[color](bold(namespace3)),
          ...stringArgs,
...
function buildInputField(field, context, source) {
  ...
  const tsProperty = property(
    field.name,
    field.isRequired ? tsType : appendSkipType(context, tsType)
  );
  if (!field.isRequired) {
    tsProperty.optional();
  }
...
const ${lowerCase(ctx.mapping.model)}With${capitalize(
  ...
  data: [
    // ... provide data here
      ...
      return `Create many ${
        ctx.plural
      } and returns the data saved in the database.
@param {${getModelArgName(
        ctx.model.name,
        ctx.action
      )}} args - Arguments to create many ${ctx.plural}.
...
var ArgsTypeBuilder = class {
  constructor(type, context, action) {
    ...
    this.moduleExport = moduleExport(
      typeDeclaration(
        getModelArgName(type.name, action),
        objectType()
  ...
  addSelectArg(selectTypeName = getSelectName(this.type.name)) {
    this.addProperty(
      property(
        "select",
        unionType([
          namedType(selectTypeName).addGenericArgument(
            extArgsParam.toArgument()
          ),
          nullType,
        ])
      )
        ...
        .setDocComment(
          docComment(
            `Select specific fields to fetch from the ${this.type.name}`
          )
        )
    );
    return this;
  ...
  addIncludeArgIfHasRelations(
    includeTypeName = getIncludeName(this.type.name),
    type = this.type
  ) {
    const hasRelationField = type.fields.some(
    ...
    this.addProperty(
      property(
        "include",
        unionType([
          namedType(includeTypeName).addGenericArgument(
            extArgsParam.toArgument()
          ),
          nullType,
        ])
        ...
        .optional()
        .setDocComment(
          docComment("Choose, which related nodes to fetch as well")
        )
    );
    return this;
  }
  addOmitArg() {
    ...
    this.addProperty(
      property(
        "omit",
        unionType([
          namedType(getOmitName(this.type.name)).addGenericArgument(
            extArgsParam.toArgument()
          ),
          nullType,
        ])
        ...
        .optional()
        .setDocComment(
          docComment(`Omit specific fields from the ${this.type.name}`)
        )
    );
    return this;
  }
  ...
  createExport() {
    ...
    this.context.defaultArgsAliases.registerArgName(
      this.moduleExport.declaration.name
    );
...
function buildIncludeType({
  ...
  const type = buildSelectOrIncludeObject(
    modelName,
    getIncludeFields(fields, context.dmmf),
    context
  );
...
function buildOmitType({ modelName, fields, context }) {
  ...
  const omitType = namedType("$Extensions.GetOmit")
...
function buildSelectOrIncludeObject(modelName, fields, context) {
  ...
  for (const field of fields) {
    ...
    objectType2.add(
      property(field.name, appendSkipType(context, fieldType)).optional()
    );
  }
  return objectType2;
}
...
var Model = class {
  constructor(model, context) {
    ...
    this.createManyAndReturnType =
      this.context.dmmf.outputTypeMap.model[
        getCreateManyAndReturnOutputType(model.name)
      ];
  ...
  get argsTypes() {
    ...
    for (const action of Object.keys(DMMF.ModelAction)) {
      ...
      if (
        ...
        argsTypes.push(
          new ArgsTypeBuilder(this.type, this.context, action)
            .addSchemaArgs(field.args)
            .createExport()
        );
      } else if (action === "createManyAndReturn") {
        const args = new ArgsTypeBuilder(this.type, this.context, action)
...
${(0, import_indent_string3.default)(
  groupByRootField.args
    .map((arg) => {
      const updatedArg = {
        ...arg,
        comment: getArgFieldJSDoc(this.type, DMMF.ModelAction.groupBy, arg),
      };
...
${(0, import_indent_string3.default)(
  aggregateRootField.args
    .map((arg) => {
      const updatedArg = {
        ...arg,
        comment: getArgFieldJSDoc(this.type, DMMF.ModelAction.aggregate, arg),
      };
      return new InputField(updatedArg, this.context).toTS();
    })
    .concat(
...
var ModelDelegate = class {
  ...
  toTS() {
    ...
    const mapping = dmmf.mappingsMap[name] ?? {
      model: name,
      plural: `${name}s`,
    };
    ...
    if (this.context.isPreviewFeatureOn("omitApi")) {
      ...
      genericDelegateParams.push(
        genericParameter("ClientOptions").default(objectType())
      );
    }
...
export interface ${name}Delegate<${genericDelegateParams
      .map((param) => stringify(param))
      .join(", ")}> {
${(0, import_indent_string3.default)(
...
function buildModelDelegateMethod(modelName, actionName, context) {
  const mapping = context.dmmf.mappingsMap[modelName] ?? {
    model: modelName,
    plural: `${modelName}s`,
  };
  const modelOrType = context.dmmf.typeAndModelMap[modelName];
  const method2 = method(actionName)
    .setDocComment(
      docComment(getMethodJSDocBody(actionName, mapping, modelOrType))
    )
...
function getNonAggregateMethodArgs(modelName, actionName) {
  ...
  if (actionName === DMMF.ModelAction.count) {
    const type2 = omit(
      ...
      unionType(stringLiteral("select"))
        .addVariant(stringLiteral("include"))
        .addVariant(stringLiteral("distinct"))
    );
  ...
  if (
    ...
    return makeParameter(
      namedType(getModelArgName(modelName, actionName))
    ).optional();
  }
  const type = namedType("SelectSubset")
    .addGenericArgument(namedType("T"))
    .addGenericArgument(
      namedType(getModelArgName(modelName, actionName)).addGenericArgument(
        extArgsParam.toArgument()
      )
    );
...
function getReturnType({
  ...
  if (actionName === DMMF.ModelAction.aggregate) {
    return promise(
      namedType(getAggregateGetName(modelName)).addGenericArgument(
        namedType("T")
      )
    );
  }
  ...
  if (isChaining && actionName === DMMF.ModelAction.findUniqueOrThrow) {
    ...
    const result = unionType(
      getResultType(modelName, actionName, context)
    ).addVariant(nullType2);
...
function getFluentWrapper(
  ...
  const result = namedType(fluentWrapperName(modelName))
    .addGenericArgument(resultType)
    .addGenericArgument(nullType2)
...
function getResultType(modelName, actionName, context) {
  const result = namedType("$Result.GetResult")
    .addGenericArgument(
      namedType(getPayloadName(modelName)).addGenericArgument(
        extArgsParam.toArgument()
      )
    )
    .addGenericArgument(namedType("T"))
    .addGenericArgument(stringLiteral(actionName));
  if (context.isPreviewFeatureOn("omitApi")) {
    result.addGenericArgument(namedType("ClientOptions"));
  }
  return result;
...
function buildFluentWrapperDefinition(modelName, outputType, context) {
  ...
  definition
    ...
    .addGenericParameter(genericParameter("Null").default(neverType))
    .addGenericParameter(extArgsParam)
    .extends(prismaPromise(namedType("T")));
  if (context.isPreviewFeatureOn("omitApi")) {
  ...
  definition.add(
    property(toStringTag, stringLiteral("PrismaPromise")).readonly()
  );
  definition.addMultiple(
    outputType.fields
      ...
      .map((field) => {
        const fieldArgType = namedType(
          getFieldArgName(field, modelName)
        ).addGenericArgument(extArgsParam.toArgument());
        const argsParam = genericParameter("T")
          .extends(fieldArgType)
          .default(objectType());
  ...
  definition.add(
    method("then")
      ...
      .addGenericParameter(genericParameter("TResult1").default(namedType("T")))
      .addGenericParameter(genericParameter("TResult2").default(neverType))
      .addParameter(
        promiseCallback(
          "onfulfilled",
          parameter("value", namedType("T")),
          namedType("TResult1")
        )
      )
      .addParameter(
        promiseCallback(
          "onrejected",
          parameter("reason", anyType),
          namedType("TResult2")
        )
      )
      .setReturnType(
        promise(unionType([namedType("TResult1"), namedType("TResult2")]))
      )
  );
  definition.add(
    method("catch")
      ...
      .addGenericParameter(genericParameter("TResult").default(neverType))
      .addParameter(
        promiseCallback(
          "onrejected",
          parameter("reason", anyType),
      ...
      .setReturnType(promise(unionType([namedType("T"), namedType("TResult")])))
  );
  definition.add(
    method("finally")
      .setDocComment(
      ...
      .addParameter(
        parameter(
          "onfinally",
          unionType([functionType(), undefinedType, nullType])
        ).optional()
      )
  ...
  return parameter(
    ...
    unionType([
      functionType()
        ...
        .setReturnType(typeOrPromiseLike(returnType)),
      undefinedType,
      nullType,
    ])
  ).optional();
...
var DMMFHelper = class {
  ...
  get compositeNames() {
    return (this._compositeNames ??= new Set(
      this.datamodel.types.map((t) => t.name)
    ));
  }
  ...
  hasEnumInNamespace(enumName, namespace2) {
    return (
      this.schema.enumTypes[namespace2]?.find(
...
function pruneRuntimeDataModel({ models }) {
  ...
  for (const modelName of Object.keys(models)) {
    ...
    for (const { name, kind, type, relationName, dbName } of models[modelName]
      .fields) {
      prunedModels[modelName].fields.push({
        name,
        kind,
        type,
        relationName,
...
function buildQueryEngineWasmModule(wasm, copyEngine, runtimeNameJs) {
  if (
    ...
    process.env.PRISMA_CLIENT_FORCE_WASM
  ) {
...
var commonCodeTS = ({
  ...
  tsWithoutNamespace:
    () => `import * as runtime from '${runtimeBase}/${runtimeNameTs}';
...
function clientTypeMapModelsDefinition(context) {
  ...
  if (modelNames.length === 0) {
    ...
    meta.add(
      property(
        "modelProps",
        unionType(modelNames.map((name) => stringLiteral(lowerCase(name))))
      )
    );
  }
  const isolationLevel = context.dmmf.hasEnumInNamespace(
  ...
  model.addMultiple(
    modelNames.map((modelName) => {
      ...
      entry.add(
        property(
          "fields",
          namedType(`Prisma.${getFieldRefsTypeName(modelName)}`)
        )
      );
      ...
      operations.addMultiple(
        actions.map((action) => {
          ...
          operationType.add(
            property(
              "args",
              namedType(argsType).addGenericArgument(extArgsParam.toArgument())
            )
          );
          operationType.add(
            property(
              "result",
              clientTypeMapModelsResultDefinition(modelName, action)
            )
          );
...
function clientTypeMapModelsResultDefinition(modelName, action) {
  if (action === "count")
    return unionType([
      optional(namedType(getCountAggregateOutputName(modelName))),
      numberType,
    ]);
  if (action === "groupBy")
    return array(optional(namedType(getGroupByName(modelName))));
  if (action === "aggregate")
    return optional(namedType(getAggregateName(modelName)));
  ...
  if (action === "createManyAndReturn")
    return array(payloadToResult(modelName));
  if (action === "updateMany") return namedType("BatchPayload");
  if (action === "findMany") return array(payloadToResult(modelName));
  if (action === "findFirst")
    return unionType([payloadToResult(modelName), nullType]);
...
function payloadToResult(modelName) {
  return namedType("$Utils.PayloadToResult").addGenericArgument(
    namedType(getPayloadName(modelName))
  );
}
function clientTypeMapOthersDefinition(context) {
  const otherOperationsNames = context.dmmf
    .getOtherOperationNames()
    .flatMap((name) => {
      const results = [`$${name}`];
...
function clientTypeMapDefinition(context) {
  const typeMap = `${stringify(
    clientTypeMapModelsDefinition(context)
  )} & ${clientTypeMapOthersDefinition(context)}`;
  return `
  ...
  const define2 = moduleExport(
    constDeclaration(
      ...
      namedType("$Extensions.ExtendsHook")
        .addGenericArgument(stringLiteral("define"))
        .addGenericArgument(namedType("Prisma.TypeMapCb"))
        .addGenericArgument(namedType("$Extensions.DefaultArgs"))
    )
  );
  return [typeMap, stringify(define2)].join("\n");
}
function extendsPropertyDefinition(context) {
  const extendsDefinition = namedType("$Extensions.ExtendsHook")
    .addGenericArgument(stringLiteral("extends"))
    .addGenericArgument(namedType("Prisma.TypeMapCb"))
    .addGenericArgument(namedType("ExtArgs"));
  if (context.isPreviewFeatureOn("omitApi")) {
    extendsDefinition
      .addGenericArgument(
        namedType("$Utils.Call")
          .addGenericArgument(namedType("Prisma.TypeMapCb"))
          .addGenericArgument(
            objectType().add(property("extArgs", namedType("ExtArgs")))
          )
      )
...
function interactiveTransactionDefinition(context) {
  ...
  const method2 = method("$transaction")
    ...
    .addParameter(parameter("options", options).optional())
    .setReturnType(returnType);
  return stringify(method2, { indentLevel: 1, newLine: "leading" });
}
...
function queryRawTypedDefinition(context) {
  ...
  const method2 = method("$queryRawTyped")
    .setDocComment(
      docComment`
    ...
    .addParameter(
      parameter(
        ...
        runtimeImportedType("TypedSql")
          .addGenericArgument(array(unknownType))
...
function applyPendingMigrationsDefinition() {
  ...
  const method2 = method("$applyPendingMigrations")
    .setReturnType(promise(voidType))
    .setDocComment(
...
`;
  ...
  buildClientOptions() {
    ...
    const transactionOptions = objectType()
      .add(property("maxWait", numberType).optional())
      .add(property("timeout", numberType).optional());
    if (
      this.context.dmmf.hasEnumInNamespace(
        "TransactionIsolationLevel",
        "prisma"
      )
    ) {
    ...
    clientOptions.add(
      property("transactionOptions", transactionOptions).optional()
        .setDocComment(docComment`
    ...
    if (
      this.runtimeNameTs === "library.js" &&
      this.context.isPreviewFeatureOn("driverAdapters")
    ) {
      clientOptions.add(
        property(
          "adapter",
    ...
    if (this.context.isPreviewFeatureOn("omitApi")) {
      clientOptions.add(
        property("omit", namedType("Prisma.GlobalOmitConfig")).optional()
          .setDocComment(docComment`
  ...
  toJS() {
    ...
    const relativeEnvPaths = {
      rootEnvPath:
        ...
        pathToPosix(
          import_path4.default.relative(outputDir, envPaths.rootEnvPath)
        ),
      schemaEnvPath:
        envPaths.schemaEnvPath &&
        pathToPosix(
          import_path4.default.relative(outputDir, envPaths.schemaEnvPath)
        ),
    };
    ...
    const config = {
      ...
      relativePath: pathToPosix(
        import_path4.default.relative(
          outputDir,
          import_path4.default.dirname(datasourceFilePath)
        )
      ),
    ...
    const relativeOutdir = import_path4.default.relative(
      process.cwd(),
      outputDir
    );
...
${this.dmmf.inputObjectTypes.prisma
  ...
  | OptionalFlat<Omit<${baseName}, 'path'>>`);
      acc.push(
        new InputType(inputType, context)
...
var DbEnumsList = class {
  constructor(enums) {
    this.enums = enums.map((dmmfEnum) => ({
      ...
      values: dmmfEnum.values.map(
        (dmmfValue) => dmmfValue.dbName ?? dmmfValue.name
      ),
    }));
  }
  isEmpty() {
...
function buildTypedQueryTs({ query, runtimeBase, runtimeName, enums }) {
  const file2 = file();
  file2.addImport(
    moduleImport(`${runtimeBase}/${runtimeName}`).asNamespace("$runtime")
  );
  ...
  factoryType.setReturnType(
    namedType("$runtime.TypedSql")
      .addGenericArgument(namedType(`${query.name}.Parameters`))
      .addGenericArgument(namedType(`${query.name}.Result`))
  );
  file2.add(
    moduleExport(constDeclaration(query.name, factoryType)).setDocComment(doc)
  );
...
function buildResultType(query, enums) {
  const type = objectType().addMultiple(
    query.resultColumns.map((column) =>
      property(column.name, getOutputType(column.typ, column.nullable, enums))
    )
  );
...
function buildTypedQueryCjs({ query, runtimeBase, runtimeName }) {
  ...
  writer.writeLine('"use strict"');
  writer.writeLine(
    `const { makeTypedQueryFactory: $mkFactory } = require("${runtimeBase}/${runtimeName}")`
  );
  writer.writeLine(
    `exports.${query.name} = /*#__PURE__*/ $mkFactory(${JSON.stringify(
      query.source
    )})`
  );
  return writer.toString();
...
function buildTypedQueryEsm({ query, runtimeBase, runtimeName }) {
  const writer = new Writer(0, void 0);
  writer.writeLine(
    `import { makeTypedQueryFactory as $mkFactory } from "${runtimeBase}/${runtimeName}"`
  );
  writer.writeLine(
    `export const ${query.name} = /*#__PURE__*/ $mkFactory(${JSON.stringify(
      query.source
    )})`
  );
  return writer.toString();
...
function buildTypedSql({
  ...
  for (const query of queries) {
    ...
    fileMap[`${query.name}.${edgeRuntimeName}.js`] =
      buildTypedQueryCjs(edgeOptions);
  ...
  fileMap[`index.${edgeRuntimeName}.mjs`] = buildIndexEsm(
    queries,
    edgeRuntimeName
  );
  fileMap[`index.${edgeRuntimeName}.js`] = buildIndexCjs(
    queries,
    edgeRuntimeName
  );
  return fileMap;
...
async function buildClient({
  ...
  if (usesWasmRuntime) {
    ...
    fileMap["wasm-worker-loader.mjs"] =
      `export default import('./query_engine_bg.wasm')`;
    fileMap["wasm-edge-light-loader.mjs"] =
...
async function getDefaultOutdir(outputDir) {
  ...
  if (
    ...
    if (
      (0, import_fs2.existsSync)(
        import_path5.default.join(process.env.INIT_CWD, "package.json")
      )
    ) {
    ...
    if (packagePath) {
      return import_path5.default.join(
        import_path5.default.dirname(packagePath),
        "node_modules/.prisma/client"
      );
    }
  }
...
To learn more about how to rename models, check out https://pris.ly/d/naming-models`;
  ...
  if (generator.previewFeatures.includes("deno") && !!globalThis.Deno) {
    await (0, import_fs_extra.ensureDir)(
      import_path5.default.join(outputDir, "deno")
    );
  }
  await writeFileMap(outputDir, fileMap);
  const runtimeDir = import_path5.default.join(
    __dirname,
    `${testMode ? "../" : ""}../runtime`
  );
  ...
  const schemaTargetPath = import_path5.default.join(
    outputDir,
    "schema.prisma"
  );
  await import_promises.default.writeFile(schemaTargetPath, datamodel, {
    encoding: "utf-8",
  });
  if (
    ...
    await import_promises.default.copyFile(
      import_path5.default.join(runtimeDir, `query_engine_bg.${suffix}.js`),
      import_path5.default.join(outputDir, `query_engine_bg.js`)
    );
  }
  try {
...
async function getGenerationDirs({
  ...
  let userRuntimeImport = isCustomOutput
    ? "./runtime"
    : "@prisma/client/runtime";
  let userOutputDir = isCustomOutput
    ? outputDir
    : await getDefaultOutdir(outputDir);
  ...
  const userPackageRoot = await (0, import_pkg_up.default)({
    cwd: import_path5.default.dirname(userOutputDir),
  });
  const userProjectRoot = userPackageRoot
    ? import_path5.default.dirname(userPackageRoot)
    : process.cwd();
  return {
...
async function verifyOutputDirectory(directory, datamodel, schemaPath) {
  ...
  try {
    content = await import_promises.default.readFile(
      import_path5.default.join(directory, "package.json"),
      "utf8"
    );
  } catch (e) {
    if (e.code === "ENOENT") {
  ...
  if (name === import_package.default.name) {
    ...
    if (
      outputDeclaration &&
      outputDeclaration.content.includes(import_package.default.name)
    ) {
      ...
      message.push(
        `${dim(outputDeclaration.lineNumber)} ${replacePackageName(
          outputLine,
          red(import_package.default.name)
        )}`
      );
      message.push("with");
      message.push(
...
async function copyRuntimeFiles({ from, to, runtimeName, sourceMaps }) {
  ...
  if (sourceMaps) {
    files.push(
      ...files
        .filter((file2) => file2.endsWith(".js"))
        .map((file2) => `${file2}.map`)
    );
  }
  await Promise.all(
    files.map((file2) =>
      import_promises.default.copyFile(
        import_path5.default.join(from, file2),
        import_path5.default.join(to, file2)
      )
    )
  );
}
async function deleteOutputDir(outputDir) {
  try {
    ...
    if (
      require(`${outputDir}/package.json`).name?.startsWith(
        GENERATED_PACKAGE_NAME_PREFIX
      )
    ) {
