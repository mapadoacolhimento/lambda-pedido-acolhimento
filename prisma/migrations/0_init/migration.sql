...
-- CreateTable
CREATE TABLE "core_integrationlogs" (
    "id" BIGSERIAL NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "core_formdata_user_id_key" ON "core_formdata"("user_id");

-- CreateIndex
CREATE INDEX "core_integrationlogs_form_data_id_3bdb0c69" ON "core_integrationlogs"("form_data_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "solidarity_users_user_id_key" ON "solidarity_users"("user_id");
...
-- AddForeignKey
ALTER TABLE "core_formdata" ADD CONSTRAINT "core_formdata_user_id_3a7f140c_fk_auth_user_id" FOREIGN KEY ("user_id") REFERENCES "auth_user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "core_integrationlogs" ADD CONSTRAINT "core_integrationlogs_form_data_id_3bdb0c69_fk_core_formdata_id" FOREIGN KEY ("form_data_id") REFERENCES "core_formdata"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
